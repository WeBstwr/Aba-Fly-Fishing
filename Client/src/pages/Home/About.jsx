          ...
          <div className="about-container">
            ...
            <div className="about-textbox">
              <p>
                ...
                enthusiasts with the finest handcrafted flies. We are committed
                to quality, craftsmanship, and ensuring every angler has the
                best tools for a successful fishing experience.
              </p>
            </div>
          </div>
          ...
          <div className="about-container">
            <div className="about-textbox">
              <p>
                ...
                promote sustainable fishing practices and elevate the fly
                fishing experience globally.
              </p>
            </div>
            <div className="about-img">
